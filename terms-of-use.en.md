...
These Terms of Use are an agreement between you and Oglasino. They explain what Oglasino is, what you agree to when you use it, what you can and cannot do, what we can and cannot do, and what happens when something goes wrong.
...
## 3. What Oglasino is — and what it isn't

**What Oglasino is.** Oglasino is a venue that connects buyers and sellers of goods. We host listings, provide search and discovery, enable messaging between users, and support reviews and reports. We moderate content and enforce these Terms.

**What Oglasino isn't.** Oglasino does not sell anything itself. We do not own, possess, inspect, or guarantee any of the goods listed on the platform. We do not handle payments, process money transfers, or escrow funds — all transactions are arranged and completed directly between the buyer and the seller, outside of Oglasino. We are not party to any transaction between users.

In practical terms, this means:

- We do not guarantee that any listing is accurate, that any item is as described, or that any seller or buyer will follow through.
- We do not collect or pay sales taxes on transactions between users; that is between the parties.
- We do not provide refunds, because no money flows through us.
...
**Age.** You must be at least **18 years old** to use Oglasino. By using the platform, you confirm that you are 18 or older. If we learn that someone under 18 has registered, we will remove the account.

**Where.** Oglasino is intended primarily for users in Serbia and Montenegro. You may access the platform from other countries, including EU member states. Local laws in your country of residence may apply in addition to these Terms.

**One account per person.** You may have only one account. Creating multiple accounts — whether to evade a ban, manipulate reviews, or for any other reason — is prohibited and is grounds for permanent banning of all related accounts.
...
**Security.** You are responsible for keeping your password and account credentials secure. You are responsible for everything that happens through your account. If you suspect your account has been used without your authorization, contact us at support@oglasino.com immediately.

**Account is personal.** Your account is yours alone. You may not transfer it, sell it, share it, lend it, or let anyone else use it.

---

## 6. Listings, content, and the rules

This is the heart of the agreement: what you can post on Oglasino, and what you cannot.

### 6.1 What you can list

Oglasino is for buying, selling, and exchanging goods. You can list new or used items that are lawful to sell in Serbia or Montenegro and that comply with these Terms.
...
- **Pirated software, copied media, or items that infringe intellectual property.**
- **Content promoting violence, hatred, or discrimination** based on race, religion, ethnicity, nationality, gender, sexual orientation, disability, or similar protected characteristic.
- **Content involving or depicting minors inappropriately.**
...
The following user conduct is prohibited:

- **Harassment** — sustained unwanted contact, threats, intimidation, or abuse of other users.
- **Fraud** — bait-and-switch, fake sales, payment scams, identity-based scams.
- **Scraping or automated access** — using bots, crawlers, scripts, or any automated means to access, copy, or download platform content.
- **Multiple accounts** — creating more than one account, including to evade a ban, manipulate reviews or ratings, or otherwise circumvent these Terms.
- **Fake reviews** — leaving reviews about interactions that did not happen, soliciting reviews in exchange for compensation, or coordinating reviews with other users.
- **Unauthorized access** — attempting to access another user's account, credential stuffing, exploiting vulnerabilities.
- **Reverse-engineering** the platform, bypassing security measures, or interfering with the platform's operation.
- **Advertising services rather than goods** — listings that are really advertisements for service businesses (cleaning, repair, consulting, etc.) rather than goods for sale.
- **Misrepresenting identity** — impersonating another person, claiming credentials you do not hold.
- **Circumventing moderation** — using coded language, image-based hiding, or repeated re-posting to keep prohibited content live after it has been removed.

### 6.4 Our enforcement stance

We take these rules seriously and enforce them actively. We are building a platform where users — buyers and sellers alike — can interact in good faith and trust that the platform is on their side. To that end:

- We will warn or temporarily restrict users for minor violations.
- We will permanently ban users for serious violations — fraud, harassment, repeated rule-breaking, or any conduct that puts other users at risk.
- We will act on credible reports promptly. We will not act on bad-faith reports.
...
- **Storing** your Content on our infrastructure (Cloudflare R2, Firestore, Postgres).
- **Displaying** your Content to other users of the platform as part of how the platform functions.
- **Translating** your Content into the platform's supported languages, using third-party translation services (currently OpenAI). See the Privacy Policy for details.
- **Moderating** your Content — reviewing it for compliance with these Terms, and removing or restricting it if it violates them.
...
- **No sublicensing.** We do not grant any third party rights to your Content beyond what is necessary to operate the platform (translation, hosting, content delivery).
- **No marketing use.** We do not use your Content in marketing materials, advertising campaigns, social media promotions, or external presentations. If we decide in the future to use platform screenshots in marketing, we will update these Terms first and tell you.
- **No AI or machine-learning training.** Oglasino does not use your Content to train any AI or machine-learning model. This commitment is in addition to the third-party commitment OpenAI makes about not training on API data.
- **No resale.** We do not sell your Content or your data to anyone. We never have, and we never will.
...
You confirm, for everything you submit to Oglasino, that:

- You own the Content or have all necessary rights to upload it.
- The Content does not infringe anyone else's intellectual property, privacy, or other rights.
- The Content does not violate Section 6.2 or 6.3.
- The information in the Content (descriptions, prices, condition, photographs) is accurate to the best of your knowledge.

You are solely responsible for the Content you submit. We do not pre-screen most Content (moderation happens reactively to reports and to automated checks for prohibited keywords), and we are not liable for any user's Content beyond our obligation to act on credible reports of violations.

---

## 8. Reviews

Reviews are a core part of how trust works on Oglasino. The Privacy Policy describes the data side of reviews. These Terms describe the rules.
...
- **Bad-faith or harassing reports are a violation of these Terms.** Filing many false reports against a user you have a personal conflict with — or coordinating reports with others — is grounds for restricting your account.

---

## 10. Termination

This section describes when and how the agreement between you and Oglasino can end.

### 10.1 You can delete your account at any time

You can delete your account from your settings page. The full process is described in the Privacy Policy (Section 8.3), including the 7-day soft-deletion window and the option to restore your account by signing in during that window.

In summary, the moment you request deletion:

- Your profile remains visible to other users with a "Scheduled for deletion" status badge.
- Your phone number is hidden.
- Your listings are hidden.
- You cannot send or receive messages.
- Reports against you remain open, so any user who has interacted with you has a final 7-day window to file a report.
- You can restore your account by signing back in within those 7 days.
- After 7 days, your account is permanently deleted (subject to the postponement cases in Section 8.4 of the Privacy Policy).

### 10.2 We can terminate or restrict your account

We may, at our discretion and proportionate to the violation, take the following actions for breaches of these Terms or our Privacy Policy:

- **Remove a single listing or piece of content** — your account is otherwise unaffected.
- **Issue a warning or penalty** against your account.
...
Oglasino does **not** currently offer any paid features or subscriptions. The platform is free to use.

We may introduce paid features (such as premium listings or subscriber tiers) in the future. When we do, we will update these Terms to describe the paid features, the price, the right of withdrawal (a 14-day right to withdraw applies under EU consumer law for paid online services), and the renewal and cancellation terms. You will not be charged for any paid feature without your explicit acceptance of the updated Terms.

---

## 12. Disclaimers

Oglasino is provided "as is" and "as available," without warranties of any kind, express or implied, to the maximum extent permitted by applicable law. We do not warrant that:
...
- Any listing, user, or transaction is accurate, authentic, lawful, or safe.
- Any goods listed exist, are as described, or will be delivered.
...
To the maximum extent permitted by applicable law, Oglasino, the operator, and any employees, contractors, or agents are not liable for any indirect, incidental, special, consequential, or punitive damages arising out of or in connection with your use of the platform. This includes (but is not limited to) losses related to:

- Failed transactions between users.
- Fraud, misrepresentation, or other misconduct by other users.
...
**Consumer rights are preserved.** Nothing in these Terms limits or excludes any liability that cannot be limited or excluded under applicable consumer-protection law. See Section 14.

---

## 14. EU consumer rights

If you are a consumer resident in the European Union, mandatory consumer-protection law applies to you in addition to these Terms. Where any provision of these Terms conflicts with a mandatory consumer-protection right that cannot be waived, the mandatory right prevails and the conflicting provision is unenforceable to the extent of the conflict.

This means, in particular, that:

- You may have rights to file disputes in the courts of your home country, regardless of the jurisdiction clause in Section 15.
...
**Governing law.** These Terms are governed by the laws of the Republic of Serbia, without regard to conflict-of-laws principles.
...
We may update these Terms from time to time — for example, when we add features, change processors, introduce paid options, or respond to changes in the law.

For material changes:

- We will update the "Last updated" date at the top of this document.
- We will display a notice on the platform.
- For changes that materially affect your rights or obligations, we will request your explicit acceptance before continued use.

For non-material changes (corrections, clarifications, contact-information updates), we will update the document and the "Last updated" date.
...
You may not transfer or assign your rights or obligations under these Terms to anyone else. Your account is personal to you.

We may transfer or assign our rights and obligations under these Terms — for example, in connection with a future incorporation of a company to operate Oglasino, a merger, a sale of the platform, or a similar event. If we do, your existing rights under this agreement transfer with us, and the new entity becomes the operator for the purposes of these Terms.

---

## 19. Severability

If any provision of these Terms is found by a court to be unenforceable, the rest of these Terms remains in full effect. The unenforceable provision will be reformed to the minimum extent necessary to make it enforceable while preserving its intent, or, if reformation is not possible, severed from these Terms.

---

## 20. Entire agreement

These Terms, together with the Privacy Policy (which is incorporated here by reference), constitute the entire agreement between you and Oglasino regarding your use of the platform. They supersede any prior agreements, communications, or representations.

---

## 21. No waiver

If we do not enforce a provision of these Terms in any particular case, that does not waive our right to enforce the provision in other cases. A failure or delay in exercising any right under these Terms does not constitute a waiver of that right.

---

## 22. Contact

**General questions, support, appeals:** support@oglasino.com
